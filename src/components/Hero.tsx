      ...
      <div className="w-full">
        ...
        <main className="relative flex-1 flex items-center justify-center w-full">
            <div className="relative flex flex-col items-start justify-center py-10 sm:py-16 px-4 max-w-5xl mx-auto">
                ...
                <p className="mt-6 text-base sm:text-lg lg:text-xl text-primary-3 max-w-2xl z-1">
                Dịch vụ Bảo lãnh & Di trú Mỹ: Gia hạn Thẻ Xanh, Thi Quốc tịch, Visa Du lịch Mỹ, Hỗ trợ xin Hộ chiếu & Visa Việt Nam.
                </p>
                {/* <button className="self-end mt-8 flex items-center gap-3 bg-primary-4 text-white font-semibold px-6 py-3 rounded-lg hover:bg-primary-5 transition-all shadow-md transform hover:scale-105">
                <span>Khám phá!</span>
                </button> */}
            </div>
        </main>
